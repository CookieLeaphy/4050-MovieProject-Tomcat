...
<%@ page import="java.util.List, entity.User, orm.ManageUser, entity.Ticket, orm.ManageTicket, orm.ManageMovie" %>
<head>
      ...
      <div class="col">
        ...
        <form action = "ChangeContactInfo" method = "get">
          <div class="form-group">
            ...
            <input id="phone" class="form-control" name ="phone" value=<%= user.getPhone() %>>
          </div>
          <div class="form-group">
      ...
      <div class="col">
        ...
        <form>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="zip" value=<%= user.getZip() %>>
